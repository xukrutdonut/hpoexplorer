...
For Raspberry Pi 5 (ARM64) users, HPOExplorer provides a dedicated Dockerfile and docker-compose configuration. 
See the [Raspberry Pi 5 Installation Guide](https://github.com/neurogenomics/HPOExplorer/blob/master/README_RPI5.md) 
for detailed instructions in Spanish/English.

Quick start on Raspberry Pi 5:

```bash
# Clone the repository or download the files
git clone https://github.com/neurogenomics/HPOExplorer.git
cd HPOExplorer
...
Access RStudio at `http://<your_rpi_ip>:8900` with username `rstudio` and the password configured in `docker-compose.yml`.  
